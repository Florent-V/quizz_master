  ...
  readTokensForElement(e) {
    ...
    return (function (e, t, s) {
      return e
        ...
        .split(/\s+/)
        .filter((e) => e.length)
        .map((e, r) => ({ element: t, attributeName: s, content: e, index: r }))
      ...
      n = (function (e) {
        const { controller: t, token: s, typeDefinition: r } = e,
          ...
          i = (function (e) {
            ...
            if (h !== u) {
              throw new Error(
                `The specified default value for the Stimulus Value "${t ? `${t}.${s}` : s}" must match the defined type "${h}". The provided default value of "${r.default}" is of type "${u}".`,
              )
            }
            if (o) return h
          })(n),
...
const ne = {
  ...
  ie = {
    array(e) {
      ...
      if (!Array.isArray(t))
        throw new TypeError(
          `expected value of type "array" but instead got value "${e}" of type "${re(t)}"`,
        )
      return t
    },
