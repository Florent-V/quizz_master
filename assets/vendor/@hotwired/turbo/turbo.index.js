  ...
  complete() {
    this.state == a.started &&
      ...
      this.followedRedirect ||
        (this.adapter.visitCompleted(this), this.delegate.visitCompleted(this)))
  }
  fail() {
    this.state == a.started &&
...
;(l.delegateConstructor = class {
  ...
  allowsImmediateRender({ element: e }, t) {
    ...
    return this.view.renderer && r && (this.view.renderer.renderElement = r), !i
  }
  viewRenderedSnapshot(e, t) {}
  preloadOnLoadLinksForView(e) {
  ...
  shouldInterceptNavigation(e, t) {
    const s = R('data-turbo-frame', t, e) || this.element.getAttribute('target')
