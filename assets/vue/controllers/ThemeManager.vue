...
const toggleDarkMode = () => {
  selectedTheme.value = isDarkMode.value ? 'light' : 'dark'
  updateTheme()
}
</script>
...
<template>
  <div class="container">
    <section class="options-container">
      ...
      <div class="flexCol">
        <label class="swap swap-rotate" :class="{ 'swap-active': isDarkMode }">
          <span class="swap-on text-3xl pb-4">
            <IconComponent icon-name="md-darkmode-outlined" />
          </span>
          <span class="swap-off text-3xl pb-4">
            <IconComponent icon-name="md-lightmode-outlined" />
          </span>
        </label>
        <input
          ref="darkToggle"
