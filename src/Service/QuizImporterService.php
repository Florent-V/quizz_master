...
class QuizImporterService
{
    ...
    //                    );
    //                    ++$this->importStats['errors'];
    //                    $this->importStats['error_messages'][] =
    // "Default locale data missing for question ID {$questionId} in level {$levelName}.";
    //                    continue;
    //                }
    //
    ...
    //            $this->importStats['error_messages'][] =
    // "Calculated difficulty level out of bounds (1-5): {$level} for {$levelName}";
    //            ++$this->importStats['errors'];
    //
    //            return null;
    //        }
