...
final class PlaySuddenDeathControllerLegacy extends AbstractController
{
    ...
    #[Route('/quiz/play/legacy-sudden-death', name: 'app_quiz_play_sudden_death_legacy', methods: ['GET', 'POST'])]
    ...
    public function question(
        ...
        try {
            ...
            return $this->render('quiz/play_sudden_death_legacy.html.twig', [
                'question'       => $question,
